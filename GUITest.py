...
class Ui_MainWindow(object):
    ...
    def run(self):
        ...
        with open("errors.txt", "w+") as error:
            subprocess.call(["python", "./tokenize.py"], stdout = error)
            ...
            if(num_lines>0):
                for line in o:
                    for part in line.split():
                        if "NameError" in part:
                            self.plainTextEdit_2.setPlainText(" किंमत माहिती नसलेले अक्षर वापरात आहे !")
    ...
    def button_click(self):
        ...
        print >> f, str
        fi = open("programMarathiInput.txt", "w")
        str = self.plainTextEdit_2.toPlainText().encode('utf-8')
        print >> fi, str
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "आपल्या गणकाला माहिती इथे पुरवा :"))
